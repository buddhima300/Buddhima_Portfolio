...
export const GlassCard = ({
  ...
  return (
    <motion.div
      ...
      className={`relative  backdrop-blur-lg border border-white/10 rounded-2xl overflow-hidden group transition-all duration-300 hover:border-white/20 ${className}`}
    >
      <div
        className={`absolute inset-0 bg-gradient-to-br opacity-20 pointer-events-none -z-10 group-hover:opacity-30 transition-opacity`}
      />
...
export const GlassButton = ({
  ...
  return primary ? (
    <motion.button
      ...
      {...motionProps}
      className={`px-6 py-3 rounded-lg bg-gradient-to-r from-orange-500 to-orange-600 font-medium hover:shadow-lg hover:shadow-blue-500/20 transition-all relative overflow-hidden ${className}`}
    >
